                ...
                if (!$cache_file) {
                    ...
                    if ($width > 0 && $height > 0) {
                        if ($composite) {
                            ...
                            error_log("MediaCacheFile: png file written: " . $this->media_cache_route . "$id-$width-$height.png");
                        } else {
                            if ($crop) {
                                $im->cropthumbnailImage($width, $height);
                            } else {
                            ...
                            error_log("MediaCacheFile: jpg file written: " . $this->media_cache_route . "$id-$width-$height.jpg");
                        }
                    } else {
    ...
    public function indexAction($slug)
    {
        if ($slug !== false) {
            ...
            if($this->getForwardSlug($page, $slug, false)){
                return $this->redirect($this->generateUrl('page_index', array('slug' => $this->getForwardSlug($page, $slug, false))));
            }
